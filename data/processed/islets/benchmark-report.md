...
- set macro F1: species=1 specimen=1 outcomes=0.931 stepPhases=0.951
- field coverage: paperType=1 protocolFamily=0.826 species=0.826 specimen=0.826 outcomes=0.587 stepPhases=0.978
- confidence: expectedIncluded=0.849 correctIncluded=0.849 incorrectIncluded=n/a
...
- field coverage: paperType=1 protocolFamily=0.81 species=0.81 specimen=0.81 outcomes=0.595 stepPhases=0.976
...
## Reviewed depth
- reviewed outcome coverage: 0.595
...
- coverage: outcomes=0.595 stepPhases=0.976

## Reviewed depth gaps
- reviewed entries missing outcome labels: 17
- reviewed entries missing step-phase labels: 1
- missing outcome evidence audit: extractor-gap=0 ambiguous-evidence=8 evidence-thin=9
...
- Supplementary cryoprotective effect of carboxylated ε-poly-L-lysine during vitriﬁcation of rat pancreatic islets | family=vitrification type=experimental evidence=evidence-thin
