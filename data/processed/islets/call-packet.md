...
- The atlas is credible enough to use for wedge-finding: reviewed gates pass, reviewed outcome coverage is 0.714, and reviewed step-phase coverage is 0.976.
...
- 12 reviewed papers still lack explicit outcome labels.
- 13 source-enrichment records are still pending.
...
- 12 reviewed in-scope papers still lack explicit outcome labels.
