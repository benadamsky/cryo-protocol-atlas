...
## Protocol families
- slow-freezing: papers=39 | chemicals=Dimethyl Sulfoxide, Sucrose, Ethylene Glycol | outcomes=transplantation, viability, function
  Most common preserved workflow in-slice, centered on Dimethyl Sulfoxide, Sucrose, Ethylene Glycol. Outcome emphasis is transplantation, viability, function, suggesting this is the baseline to beat rather than the frontier.
...
- Dimethyl Sulfoxide, Sucrose in islets, pancreatic islets
  papers=Bulk Cryopreservation of Isolated Islets of Langerhans vs Supplementary cryoprotective effect of carboxylated ε-poly-L-lysine during vitriﬁcation of rat pancreatic islets
  why it matters=Comparable species/context with shared outcome readout but different preservation families
- Ethylene Glycol in islets, pancreatic islets
  papers=Cryopreservation of Isolated Rat Islets of Langerhans in the Presence of Ethylene Glycol or Dimethyl Sulfoxide: Evaluation of Toxicity and the Dynamic Pattern of Subsequent Insulin Release in Vitro vs Acellular matrix derived from rat liver improves the functionality of rat pancreatic islets before or after vitrification
  why it matters=Comparable species/context with shared outcome readout but different preservation families
...
- Matched-species islet vitrification vs slow-freezing benchmark
  why interesting=The current islet corpus overweights slow-freezing, so a matched-species comparison is needed to separate real vitrification gains from endpoint and species confounding. Evidence papers=6, strong outcomes=3, contradictions=11.
...
- Promote islet function-heavy protocols to transplantation endpoints
  why interesting=Several islet protocols that look promising on insulin secretion or in-vitro function will reorder once they are compared on graft or transplantation outcomes. Evidence papers=6, strong outcomes=4, contradictions=2.
...
- Additive-assisted islet recovery benchmark on a fixed base cryomix
  why interesting=Several islet papers imply that recovery gains may come from adjuncts added around a standard cryomix rather than from entirely new base CPA chemistry. Evidence papers=6, strong outcomes=3, contradictions=1.
